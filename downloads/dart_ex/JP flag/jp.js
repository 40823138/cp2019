...
(function dartProgram() {
  ...
  E = {
    main: function() {
      ...
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new E.main_closure(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t1 = J.get$onClick$x(t1.querySelector("#button"));
      t3 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new E.main_closure0(), {func: 1, ret: -1, args: [t3]}), false, t3);
    },
